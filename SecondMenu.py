...
class SecondMenu:
    ...
    def __init__(self, track, timer_options=None, current_timer=0):
        self.selected_music_track = track
        self.background_music = BackgroundMusic([track])
        self.timer_options = timer_options or [30200, 10200, 5200]
    ...
    def start_game_vs_player(self, screen):
        ...
        game = Game(screen, self.color, player1_name.username, player2_name.username, self.timer_options[self.current_timer])
    ...
    def start_game_vs_computer(self, screen): 
        ...
        run = True
        clock = pygame.time.Clock()
        game = Game(screen, self.color, player1_name.username, "Computer", self.timer_options[self.current_timer])
        global score_manager, user_scores
