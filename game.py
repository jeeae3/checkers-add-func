...
class Game: 
    ...
    """
    def __init__(self, win, color, player1, player2, timerOptions, current_timer):
        """
        ...
        self.turn_timeout = timerOptions[current_timer]
        self.win = win
        self.color = color
        self.selected = None
    ...
    def check_turn_timeout(self):
        ...
        time_left = self.turn_timeout - elapsed_time
